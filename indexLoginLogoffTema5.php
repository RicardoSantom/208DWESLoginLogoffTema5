...
<html lang="en">
    <head>
        ...
        <title>Index LoginLogoff Tema 5</title>
    </head>
    <body>
        <header>
            <h1>Index LoginLogoff Tema 5</h1>
            <h2></h2>
        </header>
        <main>
            <article>
                <h3>Enunciado: Entrada a LoginLogoff Tema5</h3>
                <a href="codigoPHP/login.php" id="enlaceSecundario" title="Enlace login.php">LoginLogoff</a>
            </article>
        </main>
        <footer>
